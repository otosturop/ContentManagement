<footer class="short" id="footer">
					...
					<div class="row">
						<div class="col-md-5">
							<a href="index.php" class="logo mb-md">
								<img alt="Porto Website Template" class="img-responsive" width="97" height="32" src="dimg/huni-logo.jpg">
							</a>
						...
						<div class="col-md-3">
							...
							<ul class="social-icons mt-lg">
								...
								<li class="social-icons-youtube"><a href="<?php echo $ayarcek['ayar_youtube']; ?>" target="_blank" title="Linkedin"><i class="fa fa-youtube"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<p>© Copyright 2017. All Rights Reserved. | <a href="http://yunus.hacettepe.edu.tr/~mehmet.arikan/webfinal/index.html" target="_blank" ><?php echo $ayarcek['ayar_author']; ?></a></p>
							</div>
						</div>
					</div>
				</div>
