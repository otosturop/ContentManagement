					...
					<div class="row pt-xl">
						...
						<div class="col-md-9">
							...
							<?php 
								...
								$toplam_sayfa = ceil($toplam_icerik / $sayfala);

								$sayfa = isset($_GET['sayfa']) ? (int) $_GET['sayfa'] : 1;
								if($sayfa < 1) $sayfa = 1;
								if($sayfa > $toplam_sayfa) $sayfa = $toplam_sayfa;

								$limit = ($sayfa - 1) * $sayfala; 

						$iceriksor = $db->prepare("select * from  icerik order by icerik_zaman DESC limit $limit,$sayfala");
						$iceriksor->execute();
							...
							<div class="col-md-12">
								...
								<span class="thumb-info thumb-info-side-image thumb-info-no-zoom mt-xl">
									<span class="thumb-info-side-image-wrapper p-none hidden-xs">
										<img src="<?php echo $icerikcek['icerik_resimyol']; ?>" class="img-responsive" alt="" style="width: 400px; height: 250px;">
									...
									<span class="thumb-info-caption">
											...
											<span><?php echo $icerikcek['icerik_zaman']; ?></span>
											</span>
